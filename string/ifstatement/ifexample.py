# ask user to inter postive integer number 
#check if the given number is with in 2 of amultiple of 10
#if is with in 2 of MULIPLE 10 PRINT 
#your number is with in 2
# 
# 
# 
# 

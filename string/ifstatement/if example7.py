#in the factory we need to create program 
#find if can do the the shipment and ifn we can do the shipment 
#it will tell you how many small package we should 
#frist we need to get total kilogram of the ship ment 
